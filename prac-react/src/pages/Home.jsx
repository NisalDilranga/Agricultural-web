...
const PAGE_SIZE = 6; // courses shown initially & per load-more
...
function Home() {
    ...
    // ── Derived data ──────────────────────────────────────────────────────────
    const allDisplayCourses = [...allCourses, ...firestoreCourses];

    // All unique categories (dynamic)
    const allCategories = [...new Set(allDisplayCourses.map((c) => c.category))].sort();

    // Filter by search + selected categories
                    ...
                    ${activeFilterCount > 0
                        ...
                        {hasMore && (
                            ...
                            >
                                ...
                                >
                                    Load More ({remaining} more course{remaining !== 1 ? 's' : ''})
                                </motion.button>
